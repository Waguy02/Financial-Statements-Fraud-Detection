...
class V4BalancedCikUnbiasedtPreprocessing(noaugPreprocessing):
    NON_FRAUD_PCT = 60
    DATASET_NAME = "v5_balanced_cik_unbiased"
    ...
    def preprocess_final_dataset_index(self, index_aaer, index_mda, index_fin):
        ...
        train_index, test_index = self.split_and_save_datasets_cik_unbiased(index_final)

        return index_final, train_index, test_index


if __name__ == "__main__":
    processor = V4BalancedCikUnbiasedtPreprocessing()
    processor.run(
