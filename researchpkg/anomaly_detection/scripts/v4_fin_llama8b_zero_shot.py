...
from researchpkg.anomaly_detection.models.llm_unsloth.llm_classifier_softmax_financial import (
    train_and_evaluate_financial_softmax_model,
)
...
from researchpkg.anomaly_detection.models.llm_unsloth.llm_classifier_softmax_mda import (
    train_and_evaluate_mda_softmax_model,
)
...
if __name__ == "__main__":
    ...
    if offline:
        ...
        model_url = os.path.join(
            os.environ["HF_CACHE"], "Llama-3.1-8B-unsloth-bnb-4bit"
        )
    else:
