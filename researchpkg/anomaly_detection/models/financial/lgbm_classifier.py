...
from researchpkg.anomaly_detection.config import LGBM_EXPERIMENTS_DIR, SEED_TRAINING
...
class LgbmClassifier(BaseFinancialClassifier):
    """
    LightGBM classifier for financial anomaly detection.
    Inherits from BaseFinancialClassifier.
    """

    BASE_EXPERIMENT_DIR = LGBM_EXPERIMENTS_DIR
    ...
    def parse_experiment_name(self):
        ...
        experiment_name = (
            f"lgbm_md.{self.max_depth}_nl.{self.num_leaves}_ne.{self.num_estimators}_lr.{self.learning_rate}_"
    ...
    def setup_model(self):
        """Sets up the LightGBM model architecture with given hyperparameters."""
        params = {
            "objective": "binary",
            "metric": "auc",
            "boosting_type": "gbdt",
        ...
        logging.info(f"LightGBM model initialized with params: {params}")
        return self.model
    ...
    def load_model(self, model_path):
        """Load a pretrained LightGBM model."""
